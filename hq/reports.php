    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title font-weight-bolder text-danger">Reports</h4>
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while($row = $result->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo substr($doc_file, 0, 30) . '...'; ?></td>
                                            <td>
                                                <?php
                                                if($status === "encrypted"){
                                            ...
                                            <td>
                                                <ul class="list-group">
                                                    <li class="list-group-item">AFZ001
                                                        <span class="badge bg-primary text-white rounded-pill"><?php echo $base1 ?></span>
                                                    </li>
                                                    <li class="list-group-item">AFZ002
                                                        <span class="badge bg-primary text-white rounded-pill"><?php echo $base2 ?></span>
                                                    </li>
                                                    <li class="list-group-item">AFZ003
                                                        <span class="badge bg-primary text-white rounded-pill"><?php echo $base3 ?></span>
                                                    </li>
                                                </ul>
                                            </td>
